      ...
      <div className='flex flex-col items-center max-w-4x1 w-full overflow-hidden rounded-md bg-white border border-gray-500/20 '>
        <table className='table-fixed md:table-auto w-full overflow-hidden pb-4'>
          ...
          <tr>
            ...
            <th className='px-4 py3 font-semibold '>Student Name</th>
            <th className='px-4 py3 font-semibold  '>Course Title</th>
            <th className='px-4 py3 font-semibold  hidden sm:table-cell '>Date</th>
          </tr>
          ...
          <tbody className='text-sm text-gray-500'>
            {enrolledStudents.map((item , index)=>(
              <tr key={index} className='border-b border-gray-500/20 '>
                <td className='md:px-4 px-2 py-3 flex items-centerspace-x-3'>
